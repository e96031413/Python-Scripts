...
targetURL = 'http://www.eyny.com/forum.php?mod=forumdisplay&fid=3276'
fileName = 'eyny-TVshow-Mega.txt'


def pattern_mega_google(text):
    patterns = [
        'google', 'G D', 'GD', 'Drive', 'Google Drive', ]
...
if __name__ == "__main__":
    ...
    page = 10
    print('Start parsing eyny TVshow....')
    rs = requests.session()
